...
class TestGetElasticsearchConfig:
    ...
    def test_get_es_config_nested_format(self):
        ...
        config = {
            "elasticsearch": {
                "client": {"hosts": ["https://localhost:9200"], "username": "elastic"}
            }
        }
...
class TestGetLoggingConfig:
    ...
    def test_get_logging_config_with_values(self):
        ...
        config = {
            "logging": {"loglevel": "DEBUG", "logfile": "/var/log/deepfreeze.log"}
        }
...
class TestValidateConfig:
    ...
    def test_validate_config_with_hosts(self):
        ...
        config = {"elasticsearch": {"hosts": ["https://localhost:9200"]}}
    ...
    def test_validate_config_with_cloud_id(self):
        ...
        config = {"elasticsearch": {"cloud_id": "deployment:base64string"}}
    ...
    def test_validate_config_missing_connection(self):
        ...
        config = {"elasticsearch": {"username": "elastic", "password": "changeme"}}
