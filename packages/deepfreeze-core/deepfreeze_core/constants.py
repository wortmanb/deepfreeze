...
This module contains all constants used by the standalone deepfreeze package,
including status index configuration, provider definitions, and thaw lifecycle states.
"""
...
THAW_STATUS_REFROZEN = (
    "refrozen"  # Thaw was completed but has been refrozen (cleaned up)
)
